...
export default function () {
  ...
  let res = http.get("https://bloodpressure-ca-staging.azurewebsites.net/", { "responseType": "text" });
  ...
  res = res.submitForm({
    fields: {
      BP_Systolic: getRandomInt(70, 190).toString(), BP_Diastolic: getRandomInt(60, 100).toString()
    }
  });
